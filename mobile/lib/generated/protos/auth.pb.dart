...
class BusinessAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BusinessAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'auth'), createEmptyInstance: create)
    ..aOM<Account>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'owner', subBuilder: Account.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specialization')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobsCompleted', $pb.PbFieldType.O3)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hourlyRate', $pb.PbFieldType.OD)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ratings', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;

  BusinessAccount._() : super();
  factory BusinessAccount({
    Account? owner,
    $core.String? specialization,
    $core.int? jobsCompleted,
    $core.double? hourlyRate,
    $core.double? ratings,
  }) {
    final _result = create();
    ...
    if (jobsCompleted != null) {
      _result.jobsCompleted = jobsCompleted;
    }
    if (hourlyRate != null) {
      _result.hourlyRate = hourlyRate;
    }
    if (ratings != null) {
      _result.ratings = ratings;
    }
    return _result;
  }
  factory BusinessAccount.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BusinessAccount.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BusinessAccount clone() => BusinessAccount()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BusinessAccount copyWith(void Function(BusinessAccount) updates) => super.copyWith((message) => updates(message as BusinessAccount)) as BusinessAccount; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BusinessAccount create() => BusinessAccount._();
  BusinessAccount createEmptyInstance() => create();
  static $pb.PbList<BusinessAccount> createRepeated() => $pb.PbList<BusinessAccount>();
  @$core.pragma('dart2js:noInline')
  static BusinessAccount getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BusinessAccount>(create);
  static BusinessAccount? _defaultInstance;

  @$pb.TagNumber(1)
  Account get owner => $_getN(0);
  @$pb.TagNumber(1)
  set owner(Account v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOwner() => $_has(0);
  @$pb.TagNumber(1)
  void clearOwner() => clearField(1);
  @$pb.TagNumber(1)
  Account ensureOwner() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.int get jobsCompleted => $_getIZ(2);
  @$pb.TagNumber(3)
  set jobsCompleted($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasJobsCompleted() => $_has(2);
  @$pb.TagNumber(3)
  void clearJobsCompleted() => clearField(3);

  @$pb.TagNumber(4)
  $core.double get hourlyRate => $_getN(3);
  @$pb.TagNumber(4)
  set hourlyRate($core.double v) { $_setDouble(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasHourlyRate() => $_has(3);
  @$pb.TagNumber(4)
  void clearHourlyRate() => clearField(4);

  @$pb.TagNumber(5)
  $core.double get ratings => $_getN(4);
  @$pb.TagNumber(5)
  set ratings($core.double v) { $_setDouble(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasRatings() => $_has(4);
  @$pb.TagNumber(5)
  void clearRatings() => clearField(5);
}
