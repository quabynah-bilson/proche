...
class AuthServiceClient extends $grpc.Client {
  static final _$login = $grpc.ClientMethod<$3.LoginRequest, $1.StringValue>(
      '/auth.AuthService/login',
      ($3.LoginRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value));
  static final _$register =
      $grpc.ClientMethod<$3.RegisterRequest, $1.StringValue>(
          '/auth.AuthService/register',
          ($3.RegisterRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value));
  static final _$reset_password =
      $grpc.ClientMethod<$3.ResetPasswordRequest, $1.StringValue>(
  ...
  static final _$validate_access_token =
      $grpc.ClientMethod<$2.Empty, $3.ValidateAccessTokenResponse>(
          '/auth.AuthService/validate_access_token',
          ($2.Empty value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.ValidateAccessTokenResponse.fromBuffer(value));
  static final _$get_account = $grpc.ClientMethod<$2.Empty, $3.Account>(
  ...
  static final _$get_account_by_phone_number =
      $grpc.ClientMethod<$1.StringValue, $3.Account>(
          '/auth.AuthService/get_account_by_phone_number',
          ($1.StringValue value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.Account.fromBuffer(value));
  static final _$update_account = $grpc.ClientMethod<$3.Account, $3.Account>(
      '/auth.AuthService/update_account',
      ($3.Account value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.Account.fromBuffer(value));
  ...
  static final _$verify_phone_verification_code =
      $grpc.ClientMethod<$3.VerifyPhoneRequest, $2.Empty>(
  ...
  static final _$get_countries =
      $grpc.ClientMethod<$2.Empty, $3.GetCountriesResponse>(
          '/auth.AuthService/get_countries',
          ($2.Empty value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.GetCountriesResponse.fromBuffer(value));
  static final _$get_country_by_id =
      $grpc.ClientMethod<$1.StringValue, $3.Country>(
          '/auth.AuthService/get_country_by_id',
          ($1.StringValue value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.Country.fromBuffer(value));
  static final _$add_country = $grpc.ClientMethod<$3.Country, $3.Country>(
      '/auth.AuthService/add_country',
      ($3.Country value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.Country.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.StringValue> login($3.LoginRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$login, request, options: options);
  }

  $grpc.ResponseFuture<$1.StringValue> register($3.RegisterRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$3.ValidateAccessTokenResponse> validate_access_token(
      $2.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$validate_access_token, request, options: options);
  }

  $grpc.ResponseFuture<$3.Account> get_account($2.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$get_account, request, options: options);
  }

  $grpc.ResponseFuture<$3.Account> get_account_by_phone_number(
  ...
  $grpc.ResponseFuture<$3.Account> update_account($3.Account request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$3.GetCountriesResponse> get_countries($2.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$get_countries, request, options: options);
  }

  $grpc.ResponseFuture<$3.Country> get_country_by_id($1.StringValue request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$get_country_by_id, request, options: options);
  }

  $grpc.ResponseFuture<$3.Country> add_country($3.Country request,
      {$grpc.CallOptions? options}) {
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    $addMethod($grpc.ServiceMethod<$3.LoginRequest, $1.StringValue>(
        'login',
        login_Pre,
        false,
        false,
        ...
        ($1.StringValue value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.RegisterRequest, $1.StringValue>(
        'register',
        register_Pre,
        false,
        false,
        ...
        ($1.StringValue value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.ResetPasswordRequest, $1.StringValue>(
        'reset_password',
        reset_password_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$2.Empty, $1.StringValue>(
        ...
        ($core.List<$core.int> value) => $2.Empty.fromBuffer(value),
        ($1.StringValue value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.Empty, $3.ValidateAccessTokenResponse>(
        'validate_access_token',
        validate_access_token_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.Empty.fromBuffer(value),
        ($3.ValidateAccessTokenResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.Empty, $3.Account>(
        'get_account',
        get_account_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.Empty.fromBuffer(value),
        ($3.Account value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.StringValue, $3.Account>(
        ...
        ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value),
        ($3.Account value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.Account, $3.Account>(
        'update_account',
        update_account_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$1.StringValue, $2.Empty>(
        ...
        ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value),
        ($2.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.VerifyPhoneRequest, $2.Empty>(
    ...
    $addMethod($grpc.ServiceMethod<$1.StringValue, $1.StringValue>(
        ...
        ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value),
        ($1.StringValue value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.Empty, $3.GetCountriesResponse>(
        'get_countries',
        get_countries_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.Empty.fromBuffer(value),
        ($3.GetCountriesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.StringValue, $3.Country>(
        'get_country_by_id',
        ...
        ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value),
        ($3.Country value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$3.Country, $3.Country>(
        'add_country',
        add_country_Pre,
        false,
        false,
  ...
  $async.Future<$3.ValidateAccessTokenResponse> validate_access_token_Pre(
      $grpc.ServiceCall call, $async.Future<$2.Empty> request) async {
    return validate_access_token(call, await request);
  }

  $async.Future<$3.Account> get_account_Pre(
      $grpc.ServiceCall call, $async.Future<$2.Empty> request) async {
    return get_account(call, await request);
  }

  $async.Future<$3.Account> get_account_by_phone_number_Pre(
      $grpc.ServiceCall call, $async.Future<$1.StringValue> request) async {
    return get_account_by_phone_number(call, await request);
  }

  $async.Future<$3.Account> update_account_Pre(
      $grpc.ServiceCall call, $async.Future<$3.Account> request) async {
  ...
  $async.Future<$3.GetCountriesResponse> get_countries_Pre(
      $grpc.ServiceCall call, $async.Future<$2.Empty> request) async {
    return get_countries(call, await request);
  }

  $async.Future<$3.Country> get_country_by_id_Pre(
      $grpc.ServiceCall call, $async.Future<$1.StringValue> request) async {
    return get_country_by_id(call, await request);
  }

  $async.Future<$3.Country> add_country_Pre(
      $grpc.ServiceCall call, $async.Future<$3.Country> request) async {
  ...
  $async.Future<$3.ValidateAccessTokenResponse> validate_access_token(
      $grpc.ServiceCall call, $2.Empty request);
  $async.Future<$3.Account> get_account(
      $grpc.ServiceCall call, $2.Empty request);
  $async.Future<$3.Account> get_account_by_phone_number(
      $grpc.ServiceCall call, $1.StringValue request);
  $async.Future<$3.Account> update_account(
      $grpc.ServiceCall call, $3.Account request);
  ...
  $async.Future<$1.StringValue> get_referral_code_by_phone_number(
      $grpc.ServiceCall call, $1.StringValue request);
  $async.Future<$3.GetCountriesResponse> get_countries(
      $grpc.ServiceCall call, $2.Empty request);
  $async.Future<$3.Country> get_country_by_id(
      $grpc.ServiceCall call, $1.StringValue request);
  $async.Future<$3.Country> add_country(
      $grpc.ServiceCall call, $3.Country request);
