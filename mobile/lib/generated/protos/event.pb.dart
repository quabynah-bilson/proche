...
class GetEventByLocationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetEventByLocationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'event'), createEmptyInstance: create)
  ...
  GetEventByLocationRequest._() : super();
  factory GetEventByLocationRequest({
  ...
  factory GetEventByLocationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetEventByLocationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetEventByLocationRequest clone() => GetEventByLocationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetEventByLocationRequest copyWith(void Function(GetEventByLocationRequest) updates) => super.copyWith((message) => updates(message as GetEventByLocationRequest)) as GetEventByLocationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetEventByLocationRequest create() => GetEventByLocationRequest._();
  GetEventByLocationRequest createEmptyInstance() => create();
  static $pb.PbList<GetEventByLocationRequest> createRepeated() => $pb.PbList<GetEventByLocationRequest>();
  @$core.pragma('dart2js:noInline')
  static GetEventByLocationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetEventByLocationRequest>(create);
  static GetEventByLocationRequest? _defaultInstance;
