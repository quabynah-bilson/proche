...
import 'package:mobile/core/network/config.dart' as _i21;
...
import 'package:mobile/features/shared/data/repositories/auth.dart' as _i19;
...
import 'package:mobile/features/shared/data/repositories/local.storage.dart'
    as _i15;
import 'package:mobile/features/shared/domain/repositories/auth.dart' as _i18;
...
import 'package:mobile/features/shared/domain/repositories/local.storage.dart'
    as _i14;
import 'package:mobile/features/task/data/repositories/task.dart' as _i17;
import 'package:mobile/features/task/domain/repositories/task.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i16.BaseTaskRepository>(
        () => _i17.ProcheTaskRepository(gh<_i9.TaskServiceClient>()));
    gh.factory<_i18.BaseAuthRepository>(() => _i19.ProcheAuthRepository(
...
class _$PersistentStorageModule extends _i20.PersistentStorageModule {}

class _$SharedAppModule extends _i20.SharedAppModule {}

class _$NetworkConfigModule extends _i21.NetworkConfigModule {}
